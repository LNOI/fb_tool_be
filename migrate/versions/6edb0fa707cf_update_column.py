...
Revision ID: 6edb0fa707cf
Revises: 
Create Date: 2024-10-13 11:41:45.267602
...
def upgrade() -> None:
    ...
    sa.Column('last_sync', sa.DateTime(), nullable=True),
    sa.Column('type', sa.Enum('CRAWL', 'AUTO_POST', name='posttype'), nullable=True),
